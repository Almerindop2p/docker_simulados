...
@section('title', 'Editar Meta Keyword | Painel ADM')
@section('breadcrumb', 'Painel / SEO / Editar')
@section('page_title', 'Editar Meta Keyword')
...
@section('content')
    <section class="panel-card" aria-labelledby="titulo-form-meta-keyword">
        <div>
            <h2 id="titulo-form-meta-keyword" class="panel-title">Editar palavra-chave</h2>
            <p class="panel-subtitle">Atualize o termo utilizado no meta keywords global.</p>
        </div>
        ...
        <form id="metaKeywordForm" class="form-grid" method="POST" action="{{ route('adm.meta-keywords.update', $metaKeyword) }}" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="field">
                ...
                <input
                    ...
                    type="text"
                    maxlength="160"
                    value="{{ old('keyword', $metaKeyword->keyword) }}"
                    autocomplete="off"
                    required
    ...
    <script>
        (function () {
            ...
            function checkKeyword(value) {
                ...
                return fetch('{{ route('adm.meta-keywords.check-field') }}?value=' + encodeURIComponent(trimmed) + '&ignore_id=' + encodeURIComponent(ignoreId), {
                    method: 'GET',
                    headers: {
