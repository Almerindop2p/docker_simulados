        ...
        <form id="questaoForm" class="form-grid" method="POST" action="{{ route('adm.questoes.store') }}" enctype="multipart/form-data">
            ...
            <div class="grid-2">
                ...
                <div class="field">
                    ...
                    <textarea id="alternativa_c" name="alternativa_c" class="textarea">{{ old('alternativa_c') }}</textarea>
                ...
                <div class="field">
                    ...
                    <textarea id="alternativa_d" name="alternativa_d" class="textarea">{{ old('alternativa_d') }}</textarea>
