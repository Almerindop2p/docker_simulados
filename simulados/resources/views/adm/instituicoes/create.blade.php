...
@section('title', 'Adicionar Instituicao | Painel ADM')
@section('breadcrumb', 'Painel / Instituicao / Adicionar')
@section('page_title', 'Adicionar Instituicao')
...
@section('content')
    <section class="panel-card" aria-labelledby="titulo-form-instituicao">
        <div>
            <h2 id="titulo-form-instituicao" class="panel-title">Cadastrar nova instituicao</h2>
            <p class="panel-subtitle">Preencha os dados para adicionar uma nova instituicao ao sistema de simulados e questoes.</p>
        </div>
        ...
        <form id="instituicaoForm" class="form-grid" method="POST" action="{{ route('adm.instituicoes.store') }}" novalidate>
            @csrf

            <div class="field">
                <label class="label" for="name">Nome da instituicao</label>
                <input
                    id="name"
                    name="name"
                    class="input"
                ...
                >
                <p id="name-help" class="help">Exemplo: FGV, CEBRASPE, FCC.</p>
            ...
            <div class="field">
                ...
                >
                <p class="help">Use letras minusculas, numeros e hifen. Exemplo: instituicao-fgv.</p>
            ...
            <div class="actions">
                <button id="submitButton" class="btn btn-primary" type="submit">Cadastrar instituicao</button>
                <a class="btn btn-soft" href="{{ route('adm.instituicoes.index') }}">Cancelar</a>
            </div>
        </form>
    </section>
@endsection
...
@push('scripts')
    <script>
        (function () {
            ...
            var form = document.getElementById('instituicaoForm');
            ...
            function checkField(field, value, statusEl) {
                ...
                return fetch('{{ route('adm.instituicoes.check-field') }}?field=' + encodeURIComponent(field) + '&value=' + encodeURIComponent(trimmed), {
                    method: 'GET',
                    headers: {
