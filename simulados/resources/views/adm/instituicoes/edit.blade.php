...
@section('title', 'Editar Instituicao | Painel ADM')
@section('breadcrumb', 'Painel / Instituicao / Editar')
@section('page_title', 'Editar Instituicao')
...
@section('content')
    <section class="panel-card" aria-labelledby="titulo-form-instituicao">
        <div>
            <h2 id="titulo-form-instituicao" class="panel-title">Editar instituicao</h2>
            <p class="panel-subtitle">Atualize os dados da instituicao selecionada.</p>
        </div>
        ...
        <form id="instituicaoForm" class="form-grid" method="POST" action="{{ route('adm.instituicoes.update', $instituicao) }}" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="field">
                ...
                <input
                    ...
                    type="text"
                    maxlength="120"
                    value="{{ old('name', $instituicao->name) }}"
                    autocomplete="off"
                    required
            ...
            <div class="field">
                ...
                <input
                    ...
                    type="text"
                    maxlength="140"
                    value="{{ old('slug', $instituicao->slug) }}"
                    autocomplete="off"
                    required
    ...
    <script>
        (function () {
            ...
            function checkField(field, value, statusEl) {
                ...
                return fetch('{{ route('adm.instituicoes.check-field') }}?field=' + encodeURIComponent(field) + '&value=' + encodeURIComponent(trimmed) + '&ignore_id=' + encodeURIComponent(ignoreId), {
                    method: 'GET',
                    headers: {
