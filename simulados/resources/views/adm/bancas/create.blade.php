...
@section('title', 'Adicionar Banca | Painel ADM')
@section('breadcrumb', 'Painel / Banca / Adicionar')
@section('page_title', 'Adicionar Banca')
...
@section('content')
    <section class="panel-card" aria-labelledby="titulo-form-banca">
        <div>
            <h2 id="titulo-form-banca" class="panel-title">Cadastrar nova banca</h2>
            <p class="panel-subtitle">Preencha os dados para adicionar uma nova banca ao sistema de simulados e questoes.</p>
        </div>
        ...
        <form id="bancaForm" class="form-grid" method="POST" action="{{ route('adm.bancas.store') }}" novalidate>
            @csrf

            <div class="field">
                <label class="label" for="name">Nome da banca</label>
                <input
                    id="name"
                    name="name"
                    class="input"
            ...
            <div class="field">
                ...
                >
                <p class="help">Use letras minusculas, numeros e hifen. Exemplo: banca-fgv.</p>
            ...
            <div class="actions">
                <button id="submitButton" class="btn btn-primary" type="submit">Cadastrar banca</button>
                <a class="btn btn-soft" href="{{ route('adm.bancas.index') }}">Cancelar</a>
            </div>
        </form>
    </section>
@endsection
...
@push('scripts')
    <script>
        (function () {
            ...
            var form = document.getElementById('bancaForm');
            ...
            function checkField(field, value, statusEl) {
                ...
                return fetch('{{ route('adm.bancas.check-field') }}?field=' + encodeURIComponent(field) + '&value=' + encodeURIComponent(trimmed), {
                    method: 'GET',
                    headers: {
