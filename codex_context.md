...
---
---
### 2026-02-21T16:48:01Z

Rota /adm/inicio expandida com 2 novos cards de grafico de pizza: Top estados por visualizacao e Top paises por visualizacao. Backend (InicioController) agora envia top_states_pie e top_countries_pie em /adm/inicio/metricas/detalhes, com agregacao por PageVisitCounter e fallback RouteMetric, limite top + 'Demais'. Frontend (adm/inicio/index.blade) recebeu novos cards e renderizacao JS assincrona integrada ao refresh existente. Validado com php -l, view:cache no Docker, route:list adm/inicio e check de payload de detalhes.
---
---
---
---
### 2026-02-21T17:01:31Z

ADM questoes: alternativas A/B agora obrigatorias; C/D/E opcionais com validacao required_if pelo gabarito. Formulario create/edit atualizado (C/D opcionais), QuestaoController salva C/D/E como null quando vazio, Questao model ganhou alternativasDisponiveis() e views/controladores publicos passaram a renderizar apenas alternativas preenchidas. Criada migration 2026_02_21_170000 para tornar questoes.alternativa_c e alternativa_d nullable (com down seguro). Validado com php -l, docker compose exec app php artisan migrate --force e view:cache.
---
---
---
### 2026-02-21T17:15:23Z

ADM configuracoes: criado card de reCAPTCHA Google com status ativo/inativo + site key + secret key e rota PATCH adm/configuracoes/recaptcha. Campos recaptcha_enabled, recaptcha_site_key e recaptcha_secret_key adicionados em site_configurations (migration 2026_02_21_180000); keys salvas criptografadas via casts encrypted no model SiteConfiguration. Integrado ao cadastro: /cadastro exibe widget g-recaptcha quando ativo/configurado e CadastroController valida token no Google siteverify antes de criar usuario, retornando erro 422/withErrors quando falha. Atualizado JS do cadastro para mostrar erros de recaptcha no resumo. Validado com php -l, route:list --path=configuracoes, migrate --force e view:cache no Docker.
---
---
### 2026-02-21T17:24:31Z

reCAPTCHA v2 estendido para /login e centralizado em /login e /cadastro. LoginController agora carrega configuracao recaptcha (create) e valida token no backend via siteverify antes de autenticar (store), retornando erro g-recaptcha-response em JSON/redirect. login.blade agora inclui script reCAPTCHA condicional, bloco g-recaptcha condicional e tratamento de erro no resumo/JS. cadastro.blade recebeu ajuste CSS para centralizar widget. Validado com php -l e docker compose exec app php artisan view:cache.
---
### 2026-02-21T17:28:01Z

Removido fundo cinza do container reCAPTCHA (.recaptcha-wrap) em /cadastro e /login, mantendo centralizacao e borda. Arquivos: resources/views/auth/cadastro.blade.php e resources/views/auth/login.blade.php. View cache recompilado no Docker com php artisan view:cache.
<!-- CONTEXT_END -->
